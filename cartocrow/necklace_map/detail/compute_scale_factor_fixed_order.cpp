 ...
 */
ComputeScaleFactorFixedOrder::ComputeScaleFactorFixedOrder(const Necklace::Ptr& necklace,
...
Number ComputeScaleFactorFixedOrder::Optimize() {
	...
	const Number rho_full_necklace =
	    available_rad <= 0
	        ? 0
	        : available_rad /
...
Number ComputeScaleFactorFixedOrder::OptimizeSubProblem(const size_t I, const size_t J,
                                                        Number& max_buffer_rad) const {
