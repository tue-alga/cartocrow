...
int main(int argc, char** argv) {
	InitApplication(
	    argc, argv, "Command line application that prints a logo formatted as an svg HTML element.");

	std::cout << "<svg width='250' viewBox='0 0 200 85' xmlns='http://www.w3.org/2000/svg' "
	             "version='1.1' bounds='[[52.356,4.945],[52.354,4.947]]'>";
	std::cout << "Sorry, your browser does not support the svg tag.";
	std::cout << "<defs>";
	std::cout << "<!-- Filter declaration -->";
	std::cout << "<filter id='MyFilter' filterUnits='userSpaceOnUse' x='0' y='0' width='200' "
	             "height='120'>";
	std::cout << "<!-- offsetBlur -->";
	std::cout << "<feGaussianBlur in='SourceAlpha' stdDeviation='4' result='blur' />";
	std::cout << "<feOffset in='blur' dx='4' dy='4' result='offsetBlur' />";
	std::cout << "<!-- litPaint -->";
	std::cout << "<feSpecularLighting in='blur' surfaceScale='5' specularConstant='.75' "
	...
	std::cout << "<feComposite in='SourceGraphic' in2='specOut' operator='arithmetic' k1='0' "
	...
	std::cout << "<path fill='none' stroke='#D90000' stroke-width='10' d='M50,66 c-50,0 -50,-60 "
	             "0,-60 h100 c50,0 50,60 0,60z'/>";
	std::cout << "<path fill='#D90000' d='M60,56 c-30,0 -30,-40 0,-40 h80 c30,0 30,40 0,40z' />";
	std::cout << "<g fill='#FFFFFF' stroke='black' font-size='45' font-family='Verdana'><text "
	             "x='52' y='52'>SVG</text></g>";
	std::cout << "</g>";
	std::cout << "</svg>";
	std::cout << std::endl;
