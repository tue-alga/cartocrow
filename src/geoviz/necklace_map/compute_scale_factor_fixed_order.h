...
#ifndef GEOVIZ_NECKLACE_MAP_COMPUTE_SCALE_FACTOR_FIXED_ORDER_H
#define GEOVIZ_NECKLACE_MAP_COMPUTE_SCALE_FACTOR_FIXED_ORDER_H
...
#endif //GEOVIZ_NECKLACE_MAP_COMPUTE_SCALE_FACTOR_FIXED_ORDER_H
