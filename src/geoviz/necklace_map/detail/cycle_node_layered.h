...
#ifndef GEOVIZ_NECKLACE_MAP_DETAIL_CYCLE_NODE_LAYERED_H
#define GEOVIZ_NECKLACE_MAP_DETAIL_CYCLE_NODE_LAYERED_H
...
#endif //GEOVIZ_NECKLACE_MAP_DETAIL_CYCLE_NODE_LAYERED_H
