...
bool BinarySearch(const PolarLine& line, const Spiral& spiral, Number& t_spiral_near, Number& t_spiral_far, const Number t_precision /*= Number(1e-15)*/)
{
...
bool CheckIntersection(const SpiralSegment& segment, const PolarPoint& point) { return segment.ContainsR(point.R()); }

bool CheckIntersection(const PolarLine& line, const PolarPoint& point) { return true; }

bool CheckIntersection(const PolarSegment& segment, const PolarPoint& point) { return segment.ContainsPhi(point.phi()); }
